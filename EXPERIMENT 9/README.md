...
## Tools Used
* **sha256sum:** Standard Linux/Unix tool for SHA-256 hash generation. ( https://man7.org/linux/man-pages/man1/sha256sum.1.html)
* **md5deep / hashdeep:** For recursive hashing of entire directories. ( https://github.com/jessek/hashdeep)
## Methodology
