...
## Tools Used
* **ExifTool:** For comprehensive metadata extraction from images. (https://exiftool.org/)
* **PDFinfo:** For analyzing PDF document properties and versioning. (ttps://www.xpdfreader.com/pdfinfo-man.html)
