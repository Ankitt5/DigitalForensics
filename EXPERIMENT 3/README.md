...
## Tools Used
* **DumpIt:** For memory acquisition (RAM capture). (https://www.comae.com/dumpit/) 
* **Volatility 3:** For advanced memory forensics and artifact extraction. (https://github.com/volatilityfoundation/volatility3)
